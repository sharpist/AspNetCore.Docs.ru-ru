<span data-ttu-id="73e3a-101">Выполните следующие команды интерфейса командной строки .NET:</span><span class="sxs-lookup"><span data-stu-id="73e3a-101">Run the following .NET CLI commands:</span></span>
