...
### <a name="no-loccookies"></a><span data-ttu-id="622ff-304">:::no-loc(Cookie):::s</span><span class="sxs-lookup"><span data-stu-id="622ff-304">:::no-loc(Cookie):::s</span></span>

<span data-ttu-id="622ff-305">Объединение экземпляров `HttpMessageHandler` в пул приводит к совместному использованию объектов `:::no-loc(Cookie):::Container`.</span><span class="sxs-lookup"><span data-stu-id="622ff-305">The pooled `HttpMessageHandler` instances results in `:::no-loc(Cookie):::Container` objects being shared.</span></span> <span data-ttu-id="622ff-306">Непредвиденное совместное использование объектов `:::no-loc(Cookie):::Container` часто приводит к ошибкам в коде.</span><span class="sxs-lookup"><span data-stu-id="622ff-306">Unanticipated `:::no-loc(Cookie):::Container` object sharing often results in incorrect code.</span></span> <span data-ttu-id="622ff-307">Для приложений, которым требуются файлы :::no-loc(cookie):::, рекомендуется один из следующих подходов:</span><span class="sxs-lookup"><span data-stu-id="622ff-307">For apps that require :::no-loc(cookie):::s, consider either:</span></span>

 - <span data-ttu-id="622ff-308">отключите автоматическую обработку файлов :::no-loc(cookie):::;</span><span class="sxs-lookup"><span data-stu-id="622ff-308">Disabling automatic :::no-loc(cookie)::: handling</span></span>
...
<span data-ttu-id="622ff-310">Чтобы отключить автоматическую обработку файлов <xref:Microsoft.Extensions.DependencyInjection.HttpClientBuilderExtensions.ConfigurePrimaryHttpMessageHandler*>, вызовите :::no-loc(cookie)::::</span><span class="sxs-lookup"><span data-stu-id="622ff-310">Call <xref:Microsoft.Extensions.DependencyInjection.HttpClientBuilderExtensions.ConfigurePrimaryHttpMessageHandler*> to disable automatic :::no-loc(cookie)::: handling:</span></span>
...
### <a name="no-loccookies"></a><span data-ttu-id="622ff-508">:::no-loc(Cookie):::s</span><span class="sxs-lookup"><span data-stu-id="622ff-508">:::no-loc(Cookie):::s</span></span>

<span data-ttu-id="622ff-509">Объединение экземпляров `HttpMessageHandler` в пул приводит к совместному использованию объектов `:::no-loc(Cookie):::Container`.</span><span class="sxs-lookup"><span data-stu-id="622ff-509">The pooled `HttpMessageHandler` instances results in `:::no-loc(Cookie):::Container` objects being shared.</span></span> <span data-ttu-id="622ff-510">Непредвиденное совместное использование объектов `:::no-loc(Cookie):::Container` часто приводит к ошибкам в коде.</span><span class="sxs-lookup"><span data-stu-id="622ff-510">Unanticipated `:::no-loc(Cookie):::Container` object sharing often results in incorrect code.</span></span> <span data-ttu-id="622ff-511">Для приложений, которым требуются файлы :::no-loc(cookie):::, рекомендуется один из следующих подходов:</span><span class="sxs-lookup"><span data-stu-id="622ff-511">For apps that require :::no-loc(cookie):::s, consider either:</span></span>

 - <span data-ttu-id="622ff-512">отключите автоматическую обработку файлов :::no-loc(cookie):::;</span><span class="sxs-lookup"><span data-stu-id="622ff-512">Disabling automatic :::no-loc(cookie)::: handling</span></span>
...
<span data-ttu-id="622ff-514">Чтобы отключить автоматическую обработку файлов <xref:Microsoft.Extensions.DependencyInjection.HttpClientBuilderExtensions.ConfigurePrimaryHttpMessageHandler*>, вызовите :::no-loc(cookie)::::</span><span class="sxs-lookup"><span data-stu-id="622ff-514">Call <xref:Microsoft.Extensions.DependencyInjection.HttpClientBuilderExtensions.ConfigurePrimaryHttpMessageHandler*> to disable automatic :::no-loc(cookie)::: handling:</span></span>
...
### <a name="no-loccookies"></a><span data-ttu-id="622ff-709">:::no-loc(Cookie):::s</span><span class="sxs-lookup"><span data-stu-id="622ff-709">:::no-loc(Cookie):::s</span></span>

<span data-ttu-id="622ff-710">Объединение экземпляров `HttpMessageHandler` в пул приводит к совместному использованию объектов `:::no-loc(Cookie):::Container`.</span><span class="sxs-lookup"><span data-stu-id="622ff-710">The pooled `HttpMessageHandler` instances results in `:::no-loc(Cookie):::Container` objects being shared.</span></span> <span data-ttu-id="622ff-711">Непредвиденное совместное использование объектов `:::no-loc(Cookie):::Container` часто приводит к ошибкам в коде.</span><span class="sxs-lookup"><span data-stu-id="622ff-711">Unanticipated `:::no-loc(Cookie):::Container` object sharing often results in incorrect code.</span></span> <span data-ttu-id="622ff-712">Для приложений, которым требуются файлы :::no-loc(cookie):::, рекомендуется один из следующих подходов:</span><span class="sxs-lookup"><span data-stu-id="622ff-712">For apps that require :::no-loc(cookie):::s, consider either:</span></span>

 - <span data-ttu-id="622ff-713">отключите автоматическую обработку файлов :::no-loc(cookie):::;</span><span class="sxs-lookup"><span data-stu-id="622ff-713">Disabling automatic :::no-loc(cookie)::: handling</span></span>
...
<span data-ttu-id="622ff-715">Чтобы отключить автоматическую обработку файлов <xref:Microsoft.Extensions.DependencyInjection.HttpClientBuilderExtensions.ConfigurePrimaryHttpMessageHandler*>, вызовите :::no-loc(cookie)::::</span><span class="sxs-lookup"><span data-stu-id="622ff-715">Call <xref:Microsoft.Extensions.DependencyInjection.HttpClientBuilderExtensions.ConfigurePrimaryHttpMessageHandler*> to disable automatic :::no-loc(cookie)::: handling:</span></span>
