...
## <a name="use-httpcontext-from-no-locrazor-pages"></a><span data-ttu-id="4c3cb-106">Использование HttpContext через :::no-loc(Razor)::: Pages</span><span class="sxs-lookup"><span data-stu-id="4c3cb-106">Use HttpContext from :::no-loc(Razor)::: Pages</span></span>

<span data-ttu-id="4c3cb-107">Класс :::no-loc(Razor)::: Pages <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageModel> предоставляет свойство <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageModel.HttpContext>.</span><span class="sxs-lookup"><span data-stu-id="4c3cb-107">The :::no-loc(Razor)::: Pages <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageModel> exposes the <xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::Pages.PageModel.HttpContext> property:</span></span>
...
## <a name="use-httpcontext-from-a-no-locrazor-view"></a><span data-ttu-id="4c3cb-108">Использование HttpContext через представление :::no-loc(Razor):::</span><span class="sxs-lookup"><span data-stu-id="4c3cb-108">Use HttpContext from a :::no-loc(Razor)::: view</span></span>

<span data-ttu-id="4c3cb-109">Представления :::no-loc(Razor)::: предоставляют `HttpContext` непосредственно через свойство [:::no-loc(Razor):::Page.Context](xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::.:::no-loc(Razor):::Page.Context).</span><span class="sxs-lookup"><span data-stu-id="4c3cb-109">:::no-loc(Razor)::: views expose the `HttpContext` directly via a [:::no-loc(Razor):::Page.Context](xref:Microsoft.AspNetCore.Mvc.:::no-loc(Razor):::.:::no-loc(Razor):::Page.Context) property on the view.</span></span> <span data-ttu-id="4c3cb-110">В следующем примере имя текущего пользователя в приложении интрасети извлекается с использованием проверки подлинности Windows:</span><span class="sxs-lookup"><span data-stu-id="4c3cb-110">The following example retrieves the current username in an intranet app using Windows Authentication:</span></span>
...
## <a name="no-locblazor-and-shared-state"></a><span data-ttu-id="4c3cb-134">:::no-loc(Blazor)::: и общее состояние</span><span class="sxs-lookup"><span data-stu-id="4c3cb-134">:::no-loc(Blazor)::: and shared state</span></span>
