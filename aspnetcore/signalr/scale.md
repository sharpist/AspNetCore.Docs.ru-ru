...
* SignalR Приложение использует значительно больше ресурсов для подключения, чем веб-приложение SignalR, без.
...
Задайте для прокси- `Connection` серверов `Upgrade` и заголовков следующие SignalR значения для WebSockets:
...
## <a name="third-party-signalr-backplane-providers"></a>SignalR Сторонние поставщики объединительной платы
...
* [Документация SignalR по службе Azure](/azure/azure-signalr/signalr-overview)
