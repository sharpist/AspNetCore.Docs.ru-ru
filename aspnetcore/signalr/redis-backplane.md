...
---
# <a name="set-up-a-redis-backplane-for-aspnet-core-signalr-scale-out"></a>Настройка объединительной платы Redis для SignalR горизонтального масштабирования ASP.NET Core
