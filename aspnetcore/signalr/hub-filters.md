...
---
# <a name="use-hub-filters-in-aspnet-core-no-locsignalr"></a><span data-ttu-id="eb5f3-103">Использование фильтров концентратора в ASP.NET Core SignalR</span><span class="sxs-lookup"><span data-stu-id="eb5f3-103">Use hub filters in ASP.NET Core SignalR</span></span>
