...
### <a name="no-locsignalr-server-metrics"></a><span data-ttu-id="ae2ad-232">:::no-loc(SignalR)::: метрики сервера</span><span class="sxs-lookup"><span data-stu-id="ae2ad-232">:::no-loc(SignalR)::: server metrics</span></span>
