...
* [Хранилище на стороне сервера](#server-side-storage)
* [URL-адрес](#url)
* [Хранилище браузера](#browser-storage)
* [Служба контейнеров состояния в памяти](#in-memory-state-container-service)

### <a name="server-side-storage"></a>Хранилище на стороне сервера
...
### <a name="browser-storage"></a>Хранилище браузера
...
## <a name="in-memory-state-container-service"></a>Служба контейнеров состояния в памяти
...
1. Добавьте ссылку на пакет для [`Microsoft.AspNetCore.Components.Web.Extensions`](https://www.nuget.org/packages/Microsoft.AspNetCore.Http.Extensions).
