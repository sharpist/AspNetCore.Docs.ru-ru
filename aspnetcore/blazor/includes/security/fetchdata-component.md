<span data-ttu-id="ea4c7-101">Компонент `FetchData` показывает, как:</span><span class="sxs-lookup"><span data-stu-id="ea4c7-101">The `FetchData` component shows how to:</span></span>
