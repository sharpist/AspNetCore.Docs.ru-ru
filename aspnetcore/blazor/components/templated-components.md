...
---
# <a name="aspnet-core-no-locblazor-templated-components"></a><span data-ttu-id="23053-103">Шаблонные компоненты Blazor в ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="23053-103">ASP.NET Core Blazor templated components</span></span>
