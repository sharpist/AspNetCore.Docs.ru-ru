# <a name="blazor-server-sample-app"></a><span data-ttu-id="44059-101">Пример приложения Blazor Server</span><span class="sxs-lookup"><span data-stu-id="44059-101">Blazor Server Sample App</span></span>
