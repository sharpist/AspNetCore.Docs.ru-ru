...
### <a name="replace-identity-20-ui-with-the-identity-21-razor-class-library"></a>Замена Identity пользовательского интерфейса 2,0 на Identity Razor библиотеку классов 2,1
...
## <a name="changes-to-razor-pages-projects-razor-files"></a>Изменения в Razor файлах проектов страниц Razor
...
## <a name="changes-to-mvc-projects-razor-files"></a>Изменения в файлах проектов MVC Razor
