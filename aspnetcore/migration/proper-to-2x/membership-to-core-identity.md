...
---
# <a name="migrate-from-aspnet-membership-authentication-to-aspnet-core-20-no-locidentity"></a>Миграция с аутентификации членства ASP.NET на ASP.NET Core 2,0Identity
...
## <a name="aspnet-core-no-locidentity-20-schema"></a>IdentityСхема ASP.NET Core 2,0
