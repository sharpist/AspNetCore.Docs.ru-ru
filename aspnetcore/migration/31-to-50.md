...
>
> Возможность установить параметр в значение `false` или оставить его неопределенным, что по умолчанию имеет значение, то параметр `false` *предоставляется только для обеспечения обратной совместимости*.
>
...
Дополнительные сведения см. в разделе <xref:blazor/security/webassembly/standalone-with-microsoft-accounts>.
...
Дополнительные сведения см. в разделе <xref:blazor/security/webassembly/standalone-with-azure-active-directory>.
...
Дополнительные сведения см. в разделе <xref:blazor/security/webassembly/standalone-with-azure-active-directory-b2c>.
