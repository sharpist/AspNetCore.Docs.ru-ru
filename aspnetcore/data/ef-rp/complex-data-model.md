---
title: 'Часть 5. :::no-loc(Razor)::: Pages с EF Core в ASP.NET Core — модель данных'
author: rick-anderson
description: 'Часть 5 серии руководств по :::no-loc(Razor)::: Pages и Entity Framework.'
ms.author: riande
ms.custom: mvc
ms.date: 07/22/2019
no-loc:
...
---
# <a name="part-5-no-locrazor-pages-with-ef-core-in-aspnet-core---data-model"></a><span data-ttu-id="89d86-103">Часть 5. :::no-loc(Razor)::: Pages с EF Core в ASP.NET Core — модель данных</span><span class="sxs-lookup"><span data-stu-id="89d86-103">Part 5, :::no-loc(Razor)::: Pages with EF Core in ASP.NET Core - Data Model</span></span>
