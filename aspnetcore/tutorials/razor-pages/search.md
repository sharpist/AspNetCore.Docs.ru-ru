---
title: 'Часть 6. Добавление поиска в :::no-loc(Razor)::: Pages в ASP.NET Core'
author: rick-anderson
description: 'Часть 6 серии руководств по :::no-loc(Razor)::: Pages.'
ms.author: riande
ms.date: 12/05/2019
no-loc:
...
---
# <a name="part-6-add-search-to-aspnet-core-no-locrazor-pages"></a><span data-ttu-id="6295a-103">Часть 6. Добавление поиска в :::no-loc(Razor)::: Pages в ASP.NET Core</span><span class="sxs-lookup"><span data-stu-id="6295a-103">Part 6, add search to ASP.NET Core :::no-loc(Razor)::: Pages</span></span>
...
### <a name="add-search-by-genre-to-the-no-locrazor-page"></a><span data-ttu-id="6295a-153">Добавление поиска по жанру на страницу :::no-loc(Razor):::</span><span class="sxs-lookup"><span data-stu-id="6295a-153">Add search by genre to the :::no-loc(Razor)::: Page</span></span>
...
### <a name="add-search-by-genre-to-the-no-locrazor-page"></a><span data-ttu-id="6295a-207">Добавление поиска по жанру на страницу :::no-loc(Razor):::</span><span class="sxs-lookup"><span data-stu-id="6295a-207">Add search by genre to the :::no-loc(Razor)::: Page</span></span>
