...
---
# <a name="tutorial-create-a-no-locrazor-pages-web-app-with-aspnet-core"></a>Учебник. Создание веб-приложения Razor Pages с помощью ASP.NET Core

В этой серии руководств приводятся основные сведения о создании веб-приложения Razor Pages. 

Более подробное введение для разработчиков, уже знакомых с контроллерами и представлениями, см. в разделе <xref:razor-pages/index>.
