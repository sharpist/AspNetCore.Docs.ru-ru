...
>
> Используйте один из следующих подходов, чтобы предотвратить недоступность кода к XSS на основе DOM: _ `createElement()` и присваивание значений свойств с соответствующими методами или свойствами, такими как `node.textContent=` или Node. InnerText = ".
