...
## <a name="html-encoding-using-no-locrazor"></a>Кодирование HTML с помощьюRazor
...
## <a name="javascript-encoding-using-no-locrazor"></a>Кодирование JavaScript с помощьюRazor
...
Если требуется создать строку запроса URL-адреса с ненадежным входом в качестве значения, используйте `UrlEncoder` для кодирования значения. например следующие.
