...
## <a name="samesite-and-no-locidentity"></a>SameSite иIdentity
...
| [CookieИдентификаци](xref:Microsoft.Extensions.DependencyInjection.CookieExtensions.AddCookie*) | [CookieAuthenticationOptions.Cookie](xref:Microsoft.AspNetCore.Builder.CookieAuthenticationOptions.CookieName) | `Lax` |
...
### <a name="test-with-no-locelectron"></a>Тест сElectron
...
* [Блог по Chromium: разработчики: готовы к созданию нового SameSite = None; CookieПараметры безопасности](https://blog.chromium.org/2019/10/developers-get-ready-for-new.html)
