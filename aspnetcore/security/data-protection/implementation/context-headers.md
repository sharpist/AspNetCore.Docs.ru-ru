...
* <span data-ttu-id="7aa51-159">выходные данные блочного шифра репликации паролей (F4 74-DB 6F) и</span><span class="sxs-lookup"><span data-stu-id="7aa51-159">the block cipher PRP output (F4 74 - DB 6F) and</span></span>
