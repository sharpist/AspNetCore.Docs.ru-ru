...
* [ `[Authorize]` ] директива атрибута] (xref: Security/блазор/index # авторизовать-Attribute) ( <xref:Microsoft.AspNetCore.Authorization.AuthorizeAttribute> ) (Пример: `@attribute [Authorize(Roles = "admin")]` )
