...
ms.locfileid: "88021540"
---
# <a name="custom-storage-providers-for-aspnet-core-no-locidentity"></a>Пользовательские поставщики хранилища для ASP.NET CoreIdentity
...
## <a name="the-aspnet-core-no-locidentity-architecture"></a>Архитектура ASP.NET Core Identity
...
## <a name="aspnet-core-no-locidentity-stores-data-types"></a>ASP.NET Core Identity хранит типы данных
