...
---
# <a name="identity-model-customization-in-aspnet-core"></a>IdentityНастройка модели в ASP.NET Core
...
## <a name="identity-and-ef-core-migrations"></a>Identityи EF Core миграции
...
## <a name="the-identity-model"></a>IdentityМодель
...
Обновите *области/ Identity /IdentityHostingStartup.CS* или `Startup.ConfigureServices` замените `IdentityUser` на `ApplicationUser` .
