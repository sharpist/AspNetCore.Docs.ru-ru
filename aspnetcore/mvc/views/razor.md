...
---
# <a name="no-locrazor-syntax-reference-for-aspnet-core"></a>RazorСправочник по синтаксису для ASP.NET Core
...
## <a name="no-locrazor-code-blocks"></a>Razorблоки кода
...
Razorпредоставляет функции обработки событий для компонентов. Для получения дополнительной информации см. <xref:blazor/components/event-handling>.
...
## <a name="no-locrazor-reserved-keywords"></a>Razorзарезервированные ключевые слова

### <a name="no-locrazor-keywords"></a>Razorсловами
...
### <a name="reserved-keywords-not-used-by-no-locrazor"></a>Зарезервированные ключевые слова не используютсяRazor
